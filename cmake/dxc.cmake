...
if(SCENARIO_RUNNER_ENABLE_HLSL_SUPPORT)
    ...
    if(DXC_PATCH_FILES)
        ...
        foreach(DXC_PATCH_FILE IN LISTS DXC_PATCH_FILES)
            execute_process(
                COMMAND
                    "${GIT_EXECUTABLE}"
                    -C
            ...
            if(DXC_PATCH_REVERSE_CHECK EQUAL 0)
                message(STATUS "DXC patch ${DXC_PATCH_FILE} is already applied")
                continue()
            endif()
            ...
            if(DXC_APPLY_AND_COMMIT_PATCH EQUAL 0)
                ...
                message(FATAL_ERROR "Failed to apply DXC patch ${DXC_PATCH_FILE}")
            endif()
        endforeach()
    endif()
