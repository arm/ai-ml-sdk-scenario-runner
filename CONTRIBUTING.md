...
The Scenario Runner project is open for external contributors and welcomes
contributions. Scenario Runner is licensed under the Apache-2.0 and all accepted
contributions must have the same license.

## Developer Certificate of Origin (DCO)

Before the Scenario Runner project accepts your contribution, you need to
...
Changes to Scenario Runner should follow the
...
Configuration files for clang-format is present in the root folder of the
project.
